...
<template>
  <main class="relative isolate min-h-screen overflow-hidden bg-background text-foreground">
    <div
      class="absolute inset-x-0 top-0 -z-10 h-72 bg-[radial-gradient(circle_at_top,_color-mix(in_oklab,var(--color-primary)_10%,transparent)_0%,transparent_72%)]"
    />
    <div
      class="absolute left-1/2 top-24 -z-10 h-80 w-80 -translate-x-1/2 rounded-full border border-border/60 bg-card/40 blur-3xl"
      aria-hidden="true"
    />

    <div class="mx-auto flex min-h-screen max-w-6xl items-center px-4 py-12 sm:px-6 lg:px-8">
      <section
        class="grid w-full gap-8 overflow-hidden rounded-[2rem] border border-border/70 bg-card/80 p-6 shadow-[0_32px_120px_-48px_rgba(3,2,19,0.4)] backdrop-blur sm:p-10 lg:grid-cols-[1.15fr_0.85fr] lg:p-12"
      >
        <div class="flex flex-col justify-between gap-10">
          <div class="space-y-6">
            ...
            <div class="space-y-4">
              ...
              <p class="max-w-2xl text-base leading-7 text-muted-foreground sm:text-lg">
                The link may be outdated, the document may have moved, or the URL could be mistyped. Use one of the actions below to get back into the editor.
              </p>
            </div>
          ...
          <div class="rounded-2xl border border-border/70 bg-background/80 p-4 sm:p-5">
            <p class="text-sm font-medium text-muted-foreground">Requested path</p>
        ...
        <div class="flex items-center justify-center">
          <div
            class="relative flex aspect-square w-full max-w-md items-center justify-center rounded-[2rem] border border-border/60 bg-[linear-gradient(160deg,color-mix(in_oklab,var(--color-muted)_78%,transparent),color-mix(in_oklab,var(--color-background)_88%,transparent))] p-8"
          >
            ...
            <div class="relative flex w-full max-w-xs flex-col gap-4">
              <div class="rounded-2xl border border-border/70 bg-background/90 p-5 shadow-sm">
                <div class="flex items-center justify-between">
                  <span class="text-sm font-medium text-muted-foreground">Route status</span>
                  <span
                ...
                <div class="mt-6 flex items-end gap-3">
                  <span class="text-6xl font-semibold leading-none">404</span>
                  <span class="pb-2 text-sm text-muted-foreground">Not Found</span>
                </div>
              </div>
              ...
              <div class="grid gap-3 sm:grid-cols-2">
                <div class="rounded-2xl border border-border/70 bg-background/80 p-4">
                  ...
                  <p class="mt-2 text-sm leading-6 text-foreground">
                    Check the URL for typos before trying again.
                  </p>
                </div>
                <div class="rounded-2xl border border-border/70 bg-background/80 p-4">
                  <p class="text-xs font-semibold uppercase tracking-[0.2em] text-muted-foreground">
                  ...
                  <p class="mt-2 text-sm leading-6 text-foreground">
                    Open your saved documents to continue editing.
                  </p>
                </div>
              </div>
            </div>
